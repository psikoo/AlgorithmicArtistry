...
public class Enemy extends Character {
    ...
    public Enemy(String name, String description, int maxHP, Attack attack0, Attack attack1, Attack attack2, Action action0, Action action1) {
    ...
    private static Enemy overseer() { // TODO tune damage values
        ...
        return new Enemy("Overseer", "The Overseer appears as a Red sphere, With a frown and a one Big sharp teeth.", 100, attack0, attack1, attack2, genericAction, genericAction);
    }
    private static Enemy demonGuardian() { // TODO change attack damage info
        ...
        return new Enemy("Demon Guardian", "The Demon Guardian appears to be green with shoulders, large horns and a toothy smile.", 100, attack0, attack1, attack2, genericAction, genericAction);
    }
    private static Enemy muffet() { // TODO change attack damage info
        ...
        return new Enemy("Muffet", "Muffet is an anthropomorphic spider monster with lavender skin, five eyes, six arms, and two legs.", 100, attack0, attack1, attack2, genericAction, genericAction);
    }
    private static Enemy generic() {
        ...
        return new Enemy("GENERIC", "generic description", 100, attack0, attack1, attack2, genericAction, genericAction);
    }
}
