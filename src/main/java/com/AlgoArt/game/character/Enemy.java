...
public class Enemy extends Character {
    ...
    private static Enemy overseer() {
        ...
        return new Enemy("Overseer", "The Overseer appears as a Red sphere, With a frown and a one Big sharp teeth.", "FractalKey", 100, attack0, attack1, attack2, genericAction, genericAction);
    }
    private static Enemy demonGuardian() {
        ...
        return new Enemy("Demon Guardian", "The Demon Guardian appears to be green with shoulders, large horns and a toothy smile.", "GeometricSky", 150, attack0, attack1, attack2, genericAction, genericAction);
    }
    private static Enemy muffet() {
        ...
        return new Enemy("Muffet", "Muffet is an anthropomorphic spider monster with lavender skin, five eyes, six arms, and two legs.", "SpiderWebs", 200, attack0, attack1, attack2, genericAction, genericAction);
    }
