...
public class Player extends Character {
    ...
    private static Heal action0;
    private static Heal action1;
    private static Attack attackG = Attack.genericAttackBuilder();
    private static Heal actionG = Heal.genericActionBuilder();
    ...
    private static Player dallE() { // Easy mode
        ...
        action0 = new Heal("Dynamic Scaling", "The AI spins up a new system healing it self", 20, 0, 0);
        action1 = new Heal("Firewall Scan", "The AI executes a series of scans healing it self", 10, 75, 0);
    ...
    private static Player midjourney() { // Normal mode
        ...
        action0 = new Heal("Holographic Decoy", "The AI creates a decoy and heals amongst the distraction", 25, 0, 10);
        action1 = new Heal("Adaptive Shielding", "The AIcreates a series of shields", 10, 60, 0);
    ...
    private static Player stableD() { // Gamble mode
        ...
        action0 = new Heal("Two in Three", "There is a 33% chance of this damaging you", 66, 0, 33);
        action1 = new Heal("Coin Flip", "The AI either you heals to full HP or dies", 10000, 0, 50);
